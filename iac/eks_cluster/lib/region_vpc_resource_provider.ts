...
export class VpcResourceProvider implements ResourceProvider<IVpc> {
    ...
    provide(context: ResourceContext): IVpc {
        return new ec2.Vpc(context.scope, 'edge-eks-vpc', {
            ipAddresses: ec2.IpAddresses.cidr('10.0.0.0/16'),
            natGateways: 0,
            availabilityZones: ['us-west-2-lax-1a', 'us-west-2-lax-1b', 'us-west-2a', 'us-west-2b', 'us-west-2c', 'us-west-2d'], // VPC spans all AZs
            subnetConfiguration: [{
                cidrMask: 26,
